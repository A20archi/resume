...
- 🥇 **Topper of IDD CSE Program (Semester 1)** — 10.0 CPI  
- 🏅 **Selected in Internal Round of Smart India Hackathon (SIH) 2025**, IIT BHU  
...
```bash
# Clone this repository (resume / portfolio repo)
git clone https://github.com/A20archi/resume.git
cd resume
````
